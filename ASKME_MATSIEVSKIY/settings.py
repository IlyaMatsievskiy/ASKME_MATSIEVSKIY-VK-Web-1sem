"""
Django settings for ASKME_MATSIEVSKIY project.
...
SECRET_KEY = 'django-insecure-gm+(9$!lreoau7*0^&!$h%=kcz!^it18dqgdfftedso4ani^1v'
...
ROOT_URLCONF = 'ASKME_MATSIEVSKIY.urls'
...
WSGI_APPLICATION = 'ASKME_MATSIEVSKIY.wsgi.application'
